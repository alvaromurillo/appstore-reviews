...
server.registerTool("fetchAppStoreReviews", {
...
server.registerResource("app-reviews", "app-reviews://", {
...
server.registerPrompt("analyze-reviews", {
...
server.registerPrompt("review-summary", {
...
server.registerPrompt("compare-reviews", {
